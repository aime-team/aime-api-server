...
function initializeDropZone() {
    ...
    dropzone.innerHTML = `
        ...
        <input id="dropzone-input" class="mt-7 hidden" type="file" accept="audio/wav, audio/x-wav, audio/mp3, audio/mp4, audio/mpeg, audio/vnd.wave, audio/ogg, audio/ogg; codecs=vorbis">
