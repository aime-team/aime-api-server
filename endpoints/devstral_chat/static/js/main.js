...
modelAPI = new ModelAPI('devstral_chat', API_USER, API_KEY);
            ...
            <div class="flex items-start gap-2.5">
                <div class="flex flex-col gap-1 w-full max-w-[320px]">
                    <div class="flex items-center justify-between rtl:justify-end space-x-2 no-print">
                        ${isResponse ? '<img src="/devstral-chat/static/img/mistral_icon.png" style="width: 12px; height: 12px;">' : ''}
